				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item"><a href="deconnexion">se deconnecter</a></li>
                        ...
                        while ($v = $result->fetch(PDO::FETCH_ASSOC)) {
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="live-camera">
									<h2 class="section-title"><a href="details-id=<?php echo $v['id_rechauffement_climatique'] ;?>-idDetails=<?php echo $v['id_details_rechauffement_climatique'] ;?>"><?php echo $v['facteur']; ?></a></h2>
